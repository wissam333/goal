<template>
  <div class="page-wrap">
    <!-- Back button -->
    <!-- <div class="back-row">
      <button class="back-btn" @click="navigateTo(leaguePath('/fixtures'))">
      ...
      <div class="scoreboard-hero" :class="`status-${liveStatus}`">
        ...
        <div class="hero-teams">
          ...
          <div
            ...
            @click="navigateTo(leaguePath(`/teams/${match.homeTeam}`))"
          >
            <div class="hero-logo">
              <NuxtImg
                v-if="homeTeam?.logo"
          ...
          <div class="hero-score">
            <template v-if="liveStatus !== 'upcoming'">
              ...
              <div v-if="scoreParts.badge || scoreParts.pens" class="score-extra">
                ...
                <span v-if="scoreParts.pens" class="score-pens">
                  ({{ scoreParts.pens }} {{ $t("match.onPenalties") }})
                </span>
          ...
          <div
            ...
            @click="navigateTo(leaguePath(`/teams/${match.awayTeam}`))"
          >
            <div class="hero-logo">
              <NuxtImg
                v-if="awayTeam?.logo"
...
const { leaguePath, league } = useCurrentLeague();
...
const getTeamTitle = (teamSlug) => {
  // ponytail: try direct lookup, then strip double-prefix for buggy data
