export const MATCH_LIST_COLS =
  'slug,title,date,group,bracket_slot,venue,status,homeTeam,awayTeam,homeScore,awayScore,homeScoreAET,awayScoreAET,homePenalties,awayPenalties,resultMethod,motmWinner,cards,description,league_id'
